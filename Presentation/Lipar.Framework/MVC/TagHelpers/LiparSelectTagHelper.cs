...
{
    [HtmlTargetElement("lipar-select", TagStructure = TagStructure.WithoutEndTag)]
    public class LiparSelectHelper : TagHelper
    {
        #region Fileds
        ...
        #region Ctor
        public LiparSelectHelper(IHtmlHelper htmlHelper)
        {
