...
namespace Lipar.Data.Migrations
{
    ...
    [Migration("20210924091147_AddShoppingCartItemIdIntoShoppingCartItemTable")]
    partial class AddShoppingCartItemIdIntoShoppingCartItemTable
    {
            ...
            modelBuilder.Entity("Lipar.Entities.Domain.Application.ProductComment", b =>
                {
                    ...
                    b.Property<DateTime?>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 9, 24, 12, 41, 46, 620, DateTimeKind.Local).AddTicks(2247));
