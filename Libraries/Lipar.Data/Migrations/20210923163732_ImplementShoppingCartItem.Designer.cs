...
namespace Lipar.Data.Migrations
{
    ...
    [Migration("20210923163732_ImplementShoppingCartItem")]
    partial class ImplementShoppingCartItem
    {
            ...
            modelBuilder.Entity("Lipar.Entities.Domain.Application.ProductComment", b =>
                {
                    ...
                    b.Property<DateTime?>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 9, 23, 20, 7, 32, 88, DateTimeKind.Local).AddTicks(5003));
