...
namespace Lipar.Data.Migrations
{
    ...
    [Migration("20210911133211_ChangeTableNameDiscountTypes")]
    partial class ChangeTableNameDiscountTypes
    {
            ...
            modelBuilder.Entity("Lipar.Entities.Domain.Application.ProductComment", b =>
                {
                    ...
                    b.Property<DateTime?>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 9, 11, 18, 2, 10, 595, DateTimeKind.Local).AddTicks(248));
