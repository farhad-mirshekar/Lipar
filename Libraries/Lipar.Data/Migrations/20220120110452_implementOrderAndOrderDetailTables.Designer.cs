...
namespace Lipar.Data.Migrations
{
    ...
    [Migration("20220120110452_implementOrderAndOrderDetailTables")]
    partial class implementOrderAndOrderDetailTables
    {
            ...
            modelBuilder.Entity("Lipar.Entities.Domain.Application.OrderDetail", b =>
                {
                    ...
                    b.Property<string>("AttributeProductJson")
                    ...
                    b.Property<string>("ShoppingCartItemJson")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Lipar.Entities.Domain.Application.ProductComment", b =>
                {
                    ...
                    b.Property<DateTime?>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 1, 20, 14, 34, 51, 466, DateTimeKind.Local).AddTicks(91));
